	...
	render() {
		return (
			<div id="details" className="container wrapper well">
				...
				{this.state.loggedUser!==this.state.user?
				<div>
					<button id="but" onClick={this.insertInterests}>I'm Interested</button>
				</div>:
				<div>
					<button id="but" onClick={this.assignUser} >Assign The User</button>
				</div>}
			</div>
		)
  	}
